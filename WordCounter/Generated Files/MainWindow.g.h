...
namespace winrt::WordCounter::implementation
{
    ...
    struct __declspec(empty_bases) MainWindow_base : implements<D, WordCounter::MainWindow, composing, I...>,
        impl::require<D, winrt::Microsoft::UI::Xaml::IWindow>,
        impl::base<D, winrt::Microsoft::UI::Xaml::Window>
    {
        using base_type = MainWindow_base;
        using class_type = WordCounter::MainWindow;
        ...
        {
            return L"WordCounter.MainWindow";
        }
        MainWindow_base()
        {
...
namespace winrt::WordCounter::factory_implementation
{
    ...
    {
        using instance_type = WordCounter::MainWindow;
