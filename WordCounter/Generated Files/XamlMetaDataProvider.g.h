...
#include "winrt/WordCounter.h"
namespace winrt::WordCounter::implementation
{
    template <typename D, typename... I>
    struct __declspec(empty_bases) XamlMetaDataProvider_base : implements<D, WordCounter::XamlMetaDataProvider, I...>
    {
        using base_type = XamlMetaDataProvider_base;
        using class_type = WordCounter::XamlMetaDataProvider;
        using implements_type = typename XamlMetaDataProvider_base::implements_type;
        using implements_type::implements_type;
        
        hstring GetRuntimeClassName() const
        {
            return L"WordCounter.XamlMetaDataProvider";
        }
    };
}
namespace winrt::WordCounter::factory_implementation
{
    ...
    {
        using instance_type = WordCounter::XamlMetaDataProvider;
