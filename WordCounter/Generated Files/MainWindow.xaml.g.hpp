        ...
        case 2:
            {
                ...
                this->WordsListView(targetElement);
            }
            break;
        case 3:
            {
                auto targetElement = target.as<::winrt::Microsoft::UI::Xaml::Controls::ListView>();
                this->CountListView(targetElement);
            }
            break;
        case 4:
            {
                auto targetElement = target.as<::winrt::Microsoft::UI::Xaml::Controls::ListView>();
                this->PositionListView(targetElement);
            }
            break;
        case 5:
            {
                ...
                targetElement.Click([weakThis](::winrt::Windows::Foundation::IInspectable const& p0, ::winrt::Microsoft::UI::Xaml::RoutedEventArgs const& p1){
                    ...
                    {
                        ::winrt::get_self<D>(t)->SubmitButton_Click(p0, p1);
                    }
                });
            }
            break;
        case 6:
            {
                ...
                this->WordsTextBox(targetElement);
            }
            break;
        }
        _contentLoaded = true;
