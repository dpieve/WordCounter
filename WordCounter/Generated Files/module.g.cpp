...
void* __stdcall winrt_get_activation_factory([[maybe_unused]] std::wstring_view const& name)
{
    ...
    if (requal(name, L"WordCounter.MainWindow"))
    {
        return winrt_make_WordCounter_MainWindow();
    }

    if (requal(name, L"WordCounter.XamlMetaDataProvider"))
    {
        return winrt_make_WordCounter_XamlMetaDataProvider();
    }
